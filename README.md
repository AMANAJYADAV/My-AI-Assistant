...
## ⚙️ Core Architecture: The "Senses"
...
*   👁️ **Eyes (Computer Vision):** Captures desktop states directly into a RAM buffer (preserving SSD lifespan). Uses `llama-3.2-11b-vision-preview` via Groq to calculate precise UI coordinate geometry for screen interaction.
